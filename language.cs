...
namespace RealCity
{
    public class language
    {
        ...
        public static string[] RealCityUI_English =
        {
            ...
            "infinity garbage,receive 300 garbagecars in 1000time, will get 90K(cd time 2000,available when family>500)",
            "infinity dead,receive 300 hearsecars in 1000time,will get 50K(cd time 2500,available when family>2000)",
            "crasy traffic,receive 5K feedthrough traffic in 2000time, get 70K(cd time 3000,available when family>1000)",
    ...
    public static string[] OptionUI_Chinese =
        ...
        public static string[] RealCityUI_Chinese =
        {
            ...
            "城市收入情况(单位:元)",
            "特殊任务(1次只接受点击一样)",
            "垃圾围城,1000时间接受300卡车垃圾,可获得9万元(冷却时间2000,500家庭有效)",
            "死尸围城,1000时间接受300灵车遗体,可获得5万元(冷却时间2500,1500家庭有效)",
            "疯狂运输,2000时间接受5000过境车辆,可获得7万元(冷却时间3000,1000家庭有效)",
