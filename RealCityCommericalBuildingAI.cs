...
namespace RealCity
{
    public class pc_CommercialBuildingAI : PrivateBuildingAI
    {
        ...
        public override void CreateBuilding(ushort buildingID, ref Building data)
        {
            ...
            MainDataStore.building_money[buildingID] -= 8000 * RealCityPrivateBuildingAI.goodPrice;
                ...
                default:
                    if (material != TransferManager.TransferReason.Shopping)
                    {
                        if (material == TransferManager.TransferReason.Goods || material == TransferManager.TransferReason.Petrol || material == TransferManager.TransferReason.Food || material == TransferManager.TransferReason.Lumber || material == TransferManager.TransferReason.Coal)
                        {
                            ...
                            //sync with org game.
                            MainDataStore.building_buffer1[buildingID] = (ushort)(customBuffer + amountDelta);
                        }
                        else
                        {
        ...
        public void caculate_trade_income(ushort buildingID, ref Building data, TransferManager.TransferReason material, ref int amountDelta)
        {
            ...
            trade_tax = -amountDelta * RealCityPrivateBuildingAI.GetTaxRate(data, buildingID);
