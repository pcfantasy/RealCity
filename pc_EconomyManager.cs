...
namespace RealCity
{
    public class pc_EconomyManager
    {
        ...
        {
            int i = 0;
            Road = saveandrestore.load_float(ref i, save_data);
            Electricity = saveandrestore.load_float(ref i, save_data);
            Water = saveandrestore.load_float(ref i, save_data);
            Beautification = saveandrestore.load_float(ref i, save_data);
            Garbage = saveandrestore.load_float(ref i, save_data);
            HealthCare = saveandrestore.load_float(ref i, save_data);
            PoliceDepartment = saveandrestore.load_float(ref i, save_data);
            Education = saveandrestore.load_float(ref i, save_data);
            Monument = saveandrestore.load_float(ref i, save_data);
            FireDepartment = saveandrestore.load_float(ref i, save_data);
            PublicTransport = saveandrestore.load_float(ref i, save_data);
            Policy_cost = saveandrestore.load_float(ref i, save_data);
            Disaster = saveandrestore.load_float(ref i, save_data);
            citizen_income = saveandrestore.load_float(ref i, save_data);
            tourist_income = saveandrestore.load_float(ref i, save_data);


            resident_low_level1_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_low_level2_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_low_level3_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_low_level4_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_low_level5_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_low_eco_level1_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_low_eco_level2_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_low_eco_level3_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_low_eco_level4_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_low_eco_level5_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_high_level1_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_high_level2_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_high_level3_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_high_level4_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_high_level5_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_high_eco_level1_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_high_eco_level2_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_high_eco_level3_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_high_eco_level4_tax_income = saveandrestore.load_float(ref i, save_data);
            resident_high_eco_level5_tax_income = saveandrestore.load_float(ref i, save_data);

            commerical_low_level1_income = saveandrestore.load_float(ref i, save_data);
            commerical_low_level2_income = saveandrestore.load_float(ref i, save_data);
            commerical_low_level3_income = saveandrestore.load_float(ref i, save_data);
            commerical_high_level1_income = saveandrestore.load_float(ref i, save_data);
            commerical_high_level2_income = saveandrestore.load_float(ref i, save_data);
            commerical_high_level3_income = saveandrestore.load_float(ref i, save_data);
            commerical_lei_income = saveandrestore.load_float(ref i, save_data);
            commerical_tou_income = saveandrestore.load_float(ref i, save_data);
            commerical_eco_income = saveandrestore.load_float(ref i, save_data);
            industy_forest_income = saveandrestore.load_float(ref i, save_data);
            industy_farm_income = saveandrestore.load_float(ref i, save_data);
            industy_oil_income = saveandrestore.load_float(ref i, save_data);
            industy_ore_income = saveandrestore.load_float(ref i, save_data);
            industy_gen_level1_income = saveandrestore.load_float(ref i, save_data);
            industy_gen_level2_income = saveandrestore.load_float(ref i, save_data);
            industy_gen_level3_income = saveandrestore.load_float(ref i, save_data);
            office_gen_level1_income = saveandrestore.load_float(ref i, save_data);
            office_gen_level2_income = saveandrestore.load_float(ref i, save_data);
            office_gen_level3_income = saveandrestore.load_float(ref i, save_data);
            office_high_tech_income = saveandrestore.load_float(ref i, save_data);
            resident_low_level1_income = saveandrestore.load_float(ref i, save_data);
            resident_low_level2_income = saveandrestore.load_float(ref i, save_data);
            resident_low_level3_income = saveandrestore.load_float(ref i, save_data);
            resident_low_level4_income = saveandrestore.load_float(ref i, save_data);
            resident_low_level5_income = saveandrestore.load_float(ref i, save_data);
            resident_low_eco_level1_income = saveandrestore.load_float(ref i, save_data);
            resident_low_eco_level2_income = saveandrestore.load_float(ref i, save_data);
            resident_low_eco_level3_income = saveandrestore.load_float(ref i, save_data);
            resident_low_eco_level4_income = saveandrestore.load_float(ref i, save_data);
            resident_low_eco_level5_income = saveandrestore.load_float(ref i, save_data);
            resident_high_level1_income = saveandrestore.load_float(ref i, save_data);
            resident_high_level2_income = saveandrestore.load_float(ref i, save_data);
            resident_high_level3_income = saveandrestore.load_float(ref i, save_data);
            resident_high_level4_income = saveandrestore.load_float(ref i, save_data);
            resident_high_level5_income = saveandrestore.load_float(ref i, save_data);
            resident_high_eco_level1_income = saveandrestore.load_float(ref i, save_data);
            resident_high_eco_level2_income = saveandrestore.load_float(ref i, save_data);
            resident_high_eco_level3_income = saveandrestore.load_float(ref i, save_data);
            resident_high_eco_level4_income = saveandrestore.load_float(ref i, save_data);
            resident_high_eco_level5_income = saveandrestore.load_float(ref i, save_data);

            commerical_low_level1_trade_income = saveandrestore.load_float(ref i, save_data);
            commerical_low_level2_trade_income = saveandrestore.load_float(ref i, save_data);
            commerical_low_level3_trade_income = saveandrestore.load_float(ref i, save_data);
            commerical_high_level1_trade_income = saveandrestore.load_float(ref i, save_data);
            commerical_high_level2_trade_income = saveandrestore.load_float(ref i, save_data);
            commerical_high_level3_trade_income = saveandrestore.load_float(ref i, save_data);
            commerical_lei_trade_income = saveandrestore.load_float(ref i, save_data);
            commerical_tou_trade_income = saveandrestore.load_float(ref i, save_data);
            commerical_eco_trade_income = saveandrestore.load_float(ref i, save_data);
            industy_forest_trade_income = saveandrestore.load_float(ref i, save_data);
            industy_farm_trade_income = saveandrestore.load_float(ref i, save_data);
            industy_oil_trade_income = saveandrestore.load_float(ref i, save_data);
            industy_ore_trade_income = saveandrestore.load_float(ref i, save_data);
            industy_gen_level1_trade_income = saveandrestore.load_float(ref i, save_data);
            industy_gen_level2_trade_income = saveandrestore.load_float(ref i, save_data);
            industy_gen_level3_trade_income = saveandrestore.load_float(ref i, save_data);
            // 97*4 = 388
            // 35*4*17 = 2768

            citizen_tax_income_forui = saveandrestore.load_ints(ref i, save_data, 17);
            citizen_income_forui = saveandrestore.load_ints(ref i, save_data, 17);
            tourist_income_forui = saveandrestore.load_ints(ref i, save_data, 17);
            resident_high_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            resident_low_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            resident_high_eco_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            resident_low_eco_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            comm_high_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            comm_low_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            comm_lei_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            comm_tou_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            comm_eco_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            indu_gen_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            indu_farmer_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            indu_foresty_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            indu_oil_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            indu_ore_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            office_gen_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            office_high_tech_landincome_forui = saveandrestore.load_ints(ref i, save_data, 17);

            comm_high_tradeincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            comm_low_tradeincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            comm_lei_tradeincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            comm_tou_tradeincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            comm_eco_tradeincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            indu_gen_tradeincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            indu_farmer_tradeincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            indu_foresty_tradeincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            indu_oil_tradeincome_forui = saveandrestore.load_ints(ref i, save_data, 17);
            indu_ore_tradeincome_forui = saveandrestore.load_ints(ref i, save_data, 17);

            road_income_forui = saveandrestore.load_ints(ref i, save_data, 17);
            cemetery_income_forui = saveandrestore.load_ints(ref i, save_data, 17);
            garbage_income_forui = saveandrestore.load_ints(ref i, save_data, 17);

            road_income = saveandrestore.load_float(ref i, save_data);
            cemetery_income = saveandrestore.load_float(ref i, save_data);
            garbage_income = saveandrestore.load_float(ref i, save_data);

            police_income_forui = saveandrestore.load_ints(ref i, save_data, 17);
            firestation_income_forui = saveandrestore.load_ints(ref i, save_data, 17);
            school_income_forui = saveandrestore.load_ints(ref i, save_data, 17);

            police_income = saveandrestore.load_float(ref i, save_data);
            firestation_income = saveandrestore.load_float(ref i, save_data);
            school_income = saveandrestore.load_float(ref i, save_data);
        ...
        public int FetchResource(EconomyManager.Resource resource, int amount, ItemClass itemClass)
        {
            ...
            {
                coefficient = (float)comm_data.game_expense_divide;
            ...
            {
                Policy_cost += (float)amount / (float)comm_data.game_expense_divide;
