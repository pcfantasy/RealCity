...
{
    [HarmonyPatch]
    public class MainIndustryBuildingAIGetResourceRatePatch
    {
        public static MethodBase TargetMethod()
        {
            return typeof(MainIndustryBuildingAI).GetMethod("GetResourceRate", BindingFlags.Public | BindingFlags.Instance, null, new Type[] { typeof(ushort), typeof(Building).MakeByRefType(), typeof(EconomyManager.Resource) }, null);
        }
