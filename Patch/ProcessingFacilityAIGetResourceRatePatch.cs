...
{
	[HarmonyPatch]
	public class ProcessingFacilityAIGetResourceRatePatch
	{
		public static MethodBase TargetMethod() {
			return typeof(ProcessingFacilityAI).GetMethod("GetResourceRate", BindingFlags.Public | BindingFlags.Instance, null, new Type[] { typeof(ushort), typeof(Building).MakeByRefType(), typeof(EconomyManager.Resource) }, null);
		}
