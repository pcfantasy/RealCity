...
namespace RealCity.UI
{
    public class RealCityUI : UIPanel
    {
        ...
        private static readonly float WIDTH = 750f;
        ...
        public override void Start()
        {
            ...
            isInteractive = true;
            BringToFront();
            relativePosition = new Vector3((Loader.parentGuiView.fixedWidth / 2 + 150f), 170f);
            opacity = 1f;
        ...
        private void ShowOnGui()
        {
            ...
            tourist_income.relativePosition = new Vector3(citizen_income.relativePosition.x + 375f, citizen_income.relativePosition.y);
            ...
            resident_low_landincome.relativePosition = new Vector3(resident_high_landincome.relativePosition.x + 375f, resident_high_landincome.relativePosition.y);
            ...
            comm_low_tradeincome.relativePosition = new Vector3(comm_high_tradeincome.relativePosition.x + 375f, comm_high_tradeincome.relativePosition.y);
            ...
            from_tram.relativePosition = new Vector3(from_bus.relativePosition.x + 250f, from_bus.relativePosition.y);
            from_tram.autoSize = true;

            from_metro = AddUIComponent<UILabel>();
            from_metro.text = Localization.Get("TRAIN");
            from_metro.relativePosition = new Vector3(from_tram.relativePosition.x + 250f, from_tram.relativePosition.y);
