...
namespace RealCity.UI
{
    public class EcnomicUI : UIPanel
    {
        ...
        public override void Start()
        {
            ...
            isInteractive = true;
            BringToFront();
            relativePosition = new Vector3(200f, 170f);
            opacity = 1f;
        ...
        private void ShowOnGui()
        {
            ...
            family_count.relativePosition = new Vector3(citizen_count.relativePosition.x + 250f, citizen_count.relativePosition.y);
            ...
            citizen_salary_per_family.relativePosition = new Vector3(family_count.relativePosition.x + 250f, family_count.relativePosition.y);
            ...
            externalInvestments.relativePosition = new Vector3(profitBuildingCount.relativePosition.x + 375f, profitBuildingCount.relativePosition.y);
