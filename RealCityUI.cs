...
namespace RealCity
{
    public class RealCityUI : UIPanel
    {
        ...
        private void process_data()
        {
            ...
            for (i = 0; i < 17; i++)
            {
                citizen_tax_income_forui += (double)pc_EconomyManager.citizen_tax_income_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                citizen_income_forui+= (double)pc_EconomyManager.citizen_income_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                tourist_income_forui+= (double)pc_EconomyManager.tourist_income_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                resident_high_landincome_forui+= (double)pc_EconomyManager.resident_high_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                resident_low_landincome_forui+= (double)pc_EconomyManager.resident_low_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                resident_high_eco_landincome_forui+= (double)pc_EconomyManager.resident_high_eco_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                resident_low_eco_landincome_forui+= (double)pc_EconomyManager.resident_low_eco_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                comm_high_landincome_forui+= (double)pc_EconomyManager.comm_high_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                comm_low_landincome_forui+= (double)pc_EconomyManager.comm_low_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                comm_lei_landincome_forui+= (double)pc_EconomyManager.comm_lei_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                comm_tou_landincome_forui+= (double)pc_EconomyManager.comm_tou_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                comm_eco_landincome_forui+= (double)pc_EconomyManager.comm_eco_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                indu_gen_landincome_forui+= (double)pc_EconomyManager.indu_gen_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                indu_farmer_landincome_forui+= (double)pc_EconomyManager.indu_farmer_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                indu_foresty_landincome_forui+= (double)pc_EconomyManager.indu_foresty_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                indu_oil_landincome_forui+= (double)pc_EconomyManager.indu_oil_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                indu_ore_landincome_forui+= (double)pc_EconomyManager.indu_ore_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                office_gen_landincome_forui+= (double)pc_EconomyManager.office_gen_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                office_high_tech_landincome_forui+= (double)pc_EconomyManager.office_high_tech_landincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                comm_high_tradeincome_forui+= (double)pc_EconomyManager.comm_high_tradeincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                comm_low_tradeincome_forui+= (double)pc_EconomyManager.comm_low_tradeincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                comm_lei_tradeincome_forui+= (double)pc_EconomyManager.comm_lei_tradeincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                comm_tou_tradeincome_forui+= (double)pc_EconomyManager.comm_tou_tradeincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                comm_eco_tradeincome_forui+= (double)pc_EconomyManager.comm_eco_tradeincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                indu_gen_tradeincome_forui+= (double)pc_EconomyManager.indu_gen_tradeincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                indu_farmer_tradeincome_forui+= (double)pc_EconomyManager.indu_farmer_tradeincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                indu_foresty_tradeincome_forui+= (double)pc_EconomyManager.indu_foresty_tradeincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                indu_oil_tradeincome_forui+= (double)pc_EconomyManager.indu_oil_tradeincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                indu_ore_tradeincome_forui+= (double)pc_EconomyManager.indu_ore_tradeincome_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;

                road_income_forui += (double)pc_EconomyManager.road_income_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                cemetery_income_forui += (double)pc_EconomyManager.cemetery_income_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
                garbage_income_forui += (double)pc_EconomyManager.garbage_income_forui[i] * (float)comm_data.game_income_outcome_multiple / 100f;
            }
            ...
            citizen_tax_income_forui -= (double)pc_EconomyManager.citizen_tax_income_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            citizen_income_forui -= (double)pc_EconomyManager.citizen_income_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            tourist_income_forui -= (double)pc_EconomyManager.tourist_income_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            resident_high_landincome_forui -= (double)pc_EconomyManager.resident_high_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            resident_low_landincome_forui -= (double)pc_EconomyManager.resident_low_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            resident_high_eco_landincome_forui -= (double)pc_EconomyManager.resident_high_eco_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            resident_low_eco_landincome_forui -= (double)pc_EconomyManager.resident_low_eco_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            comm_high_landincome_forui -= (double)pc_EconomyManager.comm_high_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            comm_low_landincome_forui -= (double)pc_EconomyManager.comm_low_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            comm_lei_landincome_forui -= (double)pc_EconomyManager.comm_lei_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            comm_tou_landincome_forui -= (double)pc_EconomyManager.comm_tou_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            comm_eco_landincome_forui -= (double)pc_EconomyManager.comm_eco_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            indu_gen_landincome_forui -= (double)pc_EconomyManager.indu_gen_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            indu_farmer_landincome_forui -= (double)pc_EconomyManager.indu_farmer_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            indu_foresty_landincome_forui -= (double)pc_EconomyManager.indu_foresty_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            indu_oil_landincome_forui -= (double)pc_EconomyManager.indu_oil_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            indu_ore_landincome_forui -= (double)pc_EconomyManager.indu_ore_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            office_gen_landincome_forui -= (double)pc_EconomyManager.office_gen_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            office_high_tech_landincome_forui -= (double)pc_EconomyManager.office_high_tech_landincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            comm_high_tradeincome_forui -= (double)pc_EconomyManager.comm_high_tradeincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            comm_low_tradeincome_forui -= (double)pc_EconomyManager.comm_low_tradeincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            comm_lei_tradeincome_forui -= (double)pc_EconomyManager.comm_lei_tradeincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            comm_tou_tradeincome_forui -= (double)pc_EconomyManager.comm_tou_tradeincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            comm_eco_tradeincome_forui -= (double)pc_EconomyManager.comm_eco_tradeincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            indu_gen_tradeincome_forui -= (double)pc_EconomyManager.indu_gen_tradeincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            indu_farmer_tradeincome_forui -= (double)pc_EconomyManager.indu_farmer_tradeincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            indu_foresty_tradeincome_forui -= (double)pc_EconomyManager.indu_foresty_tradeincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            indu_oil_tradeincome_forui -= (double)pc_EconomyManager.indu_oil_tradeincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            indu_ore_tradeincome_forui -= (double)pc_EconomyManager.indu_ore_tradeincome_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;

            road_income_forui -= (double)pc_EconomyManager.road_income_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            cemetery_income_forui -= (double)pc_EconomyManager.cemetery_income_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
            garbage_income_forui -= (double)pc_EconomyManager.garbage_income_forui[comm_data.update_money_count] * (float)comm_data.game_income_outcome_multiple / 100f;
