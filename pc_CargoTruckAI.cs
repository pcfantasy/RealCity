                        ...
                        if (((info.m_class.m_service == ItemClass.Service.Industrial) || (info.m_class.m_service == ItemClass.Service.Commercial)) && ((data.m_flags & Vehicle.Flags.Importing) != (Vehicle.Flags)0))
                        {
                            ...
                            switch ((TransferManager.TransferReason)data.m_transferType)
                            {
                                case TransferManager.TransferReason.Grain:
                                    import_tax = num * 0.35f * pc_PrivateBuildingAI.food_import_price;
                                ...
                                case TransferManager.TransferReason.Logs:
                                    import_tax = num * 0.35f * pc_PrivateBuildingAI.log_import_price;
                                ...
                                case TransferManager.TransferReason.Oil:
                                    import_tax = num * 0.35f * pc_PrivateBuildingAI.oil_import_price;
                                ...
                                case TransferManager.TransferReason.Ore:
                                    import_tax = num * 0.35f * pc_PrivateBuildingAI.ore_import_price;
                                ...
                                case TransferManager.TransferReason.Lumber:
                                    import_tax = num * 0.35f * pc_PrivateBuildingAI.lumber_import_price;
                                ...
                                case TransferManager.TransferReason.Coal:
                                    import_tax = num * 0.35f * pc_PrivateBuildingAI.coal_import_price;
                                ...
                                case TransferManager.TransferReason.Petrol:
                                    import_tax = num * 0.35f * pc_PrivateBuildingAI.petrol_import_price;
                                ...
                                case TransferManager.TransferReason.Goods:
                                    import_tax = num * 0.2f * pc_PrivateBuildingAI.good_import_price / 4f;
                ...
                if ((info.m_class.m_service == ItemClass.Service.Electricity) || (info.m_class.m_service == ItemClass.Service.Water) || (info.m_class.m_service == ItemClass.Service.Disaster))
                {
                    ...
                    switch ((TransferManager.TransferReason)data.m_transferType)
                    {
                        case TransferManager.TransferReason.Petrol:
                            ...
                            product_value = num * pc_PrivateBuildingAI.petrol_import_price;
                            if ((data.m_flags & Vehicle.Flags.Importing) != (Vehicle.Flags)0)
                            {
                                import_tax = product_value * 0.35f;
                            ...
                            break;
                        case TransferManager.TransferReason.Coal:
                            product_value = num * pc_PrivateBuildingAI.coal_import_price;
                            ...
                            break;
                        case TransferManager.TransferReason.Goods:
                            product_value = num * pc_PrivateBuildingAI.good_import_price / pc_PrivateBuildingAI.goods_idex;
